...
const ENDPOINT = {
    ...
    GET_DEPARTMENTS_BY_BRANCH_ID: 'get-departments-by-branch-id',
...
const development = {
    ...
    API_URL_GET_DEPARTMENTS_BY_BRANCH_ID: `${API_BASE_URL_DEVELOPMENT}/${ENDPOINT.GET_DEPARTMENTS_BY_BRANCH_ID}`,
...
const production = {
    ...
    API_URL_GET_DEPARTMENTS_BY_BRANCH_ID: `${API_BASE_URL_PRODUCTION}/${ENDPOINT.GET_DEPARTMENTS_BY_BRANCH_ID}`,
