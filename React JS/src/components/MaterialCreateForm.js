...
const handleSubmit = (e) => {
    ...
    const url = Constants.API_URL_CREATE_MATERIAL;
    ...
    fetch(url, {
        ...
        body: JSON.stringify(materialToCreate)
      })
      ...
      props.onMaterialCreated(materialToCreate);
};

  return (
    <div>
        <form className='w-50 mx-auto'>
            <h2 className='mt-2'>Create new material</h2><br></br>
            <div className='mt-2'>
            ...
            <button onClick={() => props.onMaterialCreated(null)} className="btn btn-secondary btn-lf 2-100 mt-2">Cancel</button>
        </form>
    </div>
  )
}
